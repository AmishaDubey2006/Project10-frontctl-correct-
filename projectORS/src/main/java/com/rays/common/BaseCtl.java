...
public abstract class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	public ORSResponse get(@PathVariable long id) {
		...
		System.out.println("BaseCtl Get() method run.......Amisha Dubey");
	...
	public ORSResponse deleteMany(@PathVariable String[] ids, @RequestParam("pageNo") String pageNo,
			@RequestBody F form) {
		System.out.println("BaseCtl DeleteMany() method....Amisha Dubey... run");
		ORSResponse res = new ORSResponse(true);
		try {
...
//			}
			...
			System.out.println("Records Deleted Successfully by Amisha Dubey");
